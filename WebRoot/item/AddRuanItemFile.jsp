		...
		<div class="mian_b">
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td colspan="3" class="mian_b_bg_lm" width="95%">项目信息详细</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td colspan="3">
						<table style="width: 100%;" border="1">
							<tr>
								...
								<td width="15%" align="center"><a
									href="UploadRuanItemFile.jsp"><img
										src="..\images\Developer.png" width="120" height="120">
								</a></td>
							...
							<tr>
								<td>&nbsp;</td>
								<td align="center"><a href="UploadRuanItemFile.jsp">概念方案</a>
								</td>
								<td align="center">深化方案</td>
								<td align="center">材料清单</td>
