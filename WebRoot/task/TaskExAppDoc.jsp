...
<td width="60%">
<input id="Radio1" type="radio" name="checkResult">通过
<input id="Radio2" type="radio" name="checkResult">不通过
</td>
<td width="30%">&nbsp;</td>
</tr>
<tr>
...
<td>
<div align="center">
<a href="IssuedTask.jsp"><img src="..\images\bnt_03.gif" style="margin-right:10px;" width="80" height="22"></a>
<img src="..\images\bnt_05.gif" alt="" width="80" height="22" onclick="javascript:window.history.go(-1);"></div></td>
<td>&nbsp;</td>
</tr>
</table>
</div>
