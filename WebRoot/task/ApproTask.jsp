...
<td colspan="3" class="mian_b_bg_lm">转移申请审核</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<tr>
<td>&nbsp;</td>
<td width="10%" valign="top">转交对象：</td>
<td width="60%">
<input type="text" class="input_01" name="textfield" id="textfield"> 选择人...... </td>
<td width="25%">&nbsp;</td>
</tr>
<tr>
<td>&nbsp;</td>
<td valign="top">详细意见：</td>
<td>
...
<td>&nbsp;</td>
<td>
<div align="center"><a href="MoveTask.jsp"><img src="..\images\bnt_03.gif" style="margin-right:10px;" width="80" height="22"></a><a href="MoveTask.jsp"><img src="..\images\bnt_05.gif" alt="" width="80" height="22"></a></div></td>
<td>&nbsp;</td>
</tr>
</table>
</div>
