...
<div class="mian_b">
<div class="mian_b1">
<a href="AddRole.jsp" title="添加"><p class="mian_b1_a1"></a>
...
<td>1</td>
<td>公司的总管</td>
<td width="8%" class="mian_b_icon_01"><a href="AddRole.jsp">分配权限</a></td>
<td width="8%" class="mian_b_icon_02"><a href="AddRole.jsp">查看</a></td>
</tr>
<tr>
